...
import { AppErrorFilter } from 'src/modules/common/exception-filters/app-error-exception.filter';
...
async function bootstrap() {
  ...
  if (APP_ENABLE_LOG === 'true') {
    ...
    app.useGlobalFilters(new NotFoundExceptionFilter(), new AppErrorFilter());
  } else {
